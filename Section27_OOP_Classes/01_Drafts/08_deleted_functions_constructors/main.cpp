...
public:
    ...
    Employee(int _salary, string _name)
    {
        salary = new int; 
        *salary = _salary; 
    ...
    Employee(double _salary, string _name) = delete; 
...
int main(int argc, char const *argv[])
{
    ...
    Employee e2; /* default constructor */

    // Employee e3(10.32, "Mostafa"); // An example on deleted constructors 
